...
const Header = () => {
  ...
  return (
    <div
      ...
      style={{ paddingBottom: "8%", height: "100vh", overflow: "auto" }}
    >
      {md ? (
        <>
          <Row>
            <Col className="front-particles" span={12}>
              <a href="https://github.com/edwardc91">
                <Image
                  ...
                  style={{ width: 130 }}
                />
                <Title className="title font-pixel" level={3}>
                  {" "}
                  {t("header.check_github", "Check my github here")}
                </Title>
              </a>
            </Col>
          </Row>
      ...
      <Row justify="center" style={{}}>
        <Col
          ...
          span={12}
          style={{ textAlign: "center", marginTop: md ? "5%" : "50%" }}
        >
          <Image
      ...
      <Row justify="center" style={{ marginTop: "2%", textAlign: "center" }}>
        <Col span={12} className="front-particles">
          <Title className="title font-pixel" level={md ? 2 : 5}>
            <Typed
              strings={[
                t("header.description_1", "Fullstack Developer"),
                t("header.description_2", "Backend Developer"),
                t("header.description_3", "Graphics Engine enthusiastic"),
                t("header.description_4", "Also i love huskies"),
              ]}
              typeSpeed={40}
              backSpeed={50}
              loop
        ...
        <Col span={12} className="front-particles">
          {md ? (
            <Title className="title font-pixel" level={5}>
              {t("header.keep_scrolling", "Keep scrolling to learn more...")}
            </Title>
          ) : (
            <span className="title font-pixel">
              {t("header.keep_scrolling", "Keep scrolling to learn more...")}
            </span>
          )}
        </Col>
